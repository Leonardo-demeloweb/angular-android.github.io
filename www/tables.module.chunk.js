...
var DataTableComponent = (function () {
    function DataTableComponent(userService, router, localStorageService) {
        this.userService = userService;
        this.router = router;
        this.localStorageService = localStorageService;
        this.dataTable = {
            headerRow: ['Nome', 'Sobrenome', 'Evento', 'E-mail'],
            footerRow: ['Nome', 'Sobrenome', 'Evento', 'E-mail'],
            dataRows: []
        };
    ...
    DataTableComponent.prototype.initTable = function (table) {
